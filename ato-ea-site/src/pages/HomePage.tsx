    ...
    return (
        <div id="HomepageContainer" className="flex flex-col justify-center items-center">
            ...
            <div data-aos="fade-up" id="Philo" className="w-full 2xl:max-w-[80%] mb-10 lg:mb-20 h-auto px-3 md:px-10 flex flex-col lg:flex-row gap-0 lg:gap-5 relative">
                <div className="w-full lg:w-[45%] h-52 md:h-96 lg:h-auto rounded-tl-3xl rounded-tr-3xl rounded-bl-none lg:rounded-bl-3xl rounded-br-none lg:rounded-br-3xl bg-philo bg-cover bg-no-repeat bg-center"></div>
            ...
            <div data-aos="fade-up" id="JoinUs" className="w-screen mb-20 flex flex-col items-center justify-center lg:gap-14 py-3 lg:py-14 lg:px-20 bg-azure">
                ...
                <a href="/how-to-join" className="mb-5 lg:mb-0 w-80 h-24 scale-75 lg:scale-100 text-black bg-old-gold rounded-full flex items-center justify-center transition-all duration-300 hover:text-neutral-700 hover:bg-dark-gold hover:text-neutral-700">
                    <div className=" text-4xl font-bold leading-10">Start Here</div>
                </a>
            </div>
